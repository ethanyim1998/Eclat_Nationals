...
public class SettingsFragment extends PreferenceFragment implements Constants {
    ...
    private Preference logoutPreference, itemContactUs, aboutPreference, changePassword, itemTerms, itemThanks, itemBlackList, itemNotifications, itemDeactivateAccount;
    private CheckBoxPreference allowComments, allowMessages;

    private ProgressDialog pDialog;

    int mAllowComments, mAllowMessages;
