...
import ru.hhsfbla.network.adapter.PeopleListAdapter;
...
public class LikesActivity extends ActivityBase implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            usersAdapter = new PeopleListAdapter(LikesActivity.this, usersList);
