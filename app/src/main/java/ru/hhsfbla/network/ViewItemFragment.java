...
import ru.hhsfbla.network.adapter.CommentListAdapter;
import ru.hhsfbla.network.app.App;
import ru.hhsfbla.network.constants.Constants;
import ru.hhsfbla.network.dialogs.CommentActionDialog;
import ru.hhsfbla.network.dialogs.CommentDeleteDialog;
import ru.hhsfbla.network.dialogs.MyCommentActionDialog;
...
import ru.hhsfbla.network.model.Comment;
import ru.hhsfbla.network.model.Item;
import ru.hhsfbla.network.util.Api;
import ru.hhsfbla.network.util.CommentInterface;
...
public class ViewItemFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener, CommentInterface, TagClick {
    ...
    ResizableImageView mItemImg, mRePostItemImg;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRePostItemImg = (ResizableImageView) mListViewHeader.findViewById(R.id.rePostItemImg);
