...
public interface Constants {
    ...
    public static final String WEB_SITE = "http://www.eclat.hhsfbla.com/";  //web site url address "http://www.eclat.hhsfbla.com/"
    ...
    public static final String API_DOMAIN = "http://www.eclat.hhsfbla.com/";  //url address to which the application sends requests
