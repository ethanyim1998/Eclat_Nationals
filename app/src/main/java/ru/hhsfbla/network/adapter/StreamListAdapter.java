...
public class StreamListAdapter extends BaseAdapter implements Constants, TagClick {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item.getFromUserPhotoUrl().length() != 0) {
            ...
            imageLoader.get("http://eclat.hhsfbla.com/" + urlPre.substring(index), ImageLoader.getImageListener(viewHolder.itemAuthorPhoto, R.drawable.profile_default_photo, R.drawable.profile_default_photo));
