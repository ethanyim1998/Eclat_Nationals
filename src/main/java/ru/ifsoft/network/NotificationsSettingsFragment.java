...
public class NotificationsSettingsFragment extends PreferenceFragment implements Constants {
    ...
    private CheckBoxPreference mAllowLikesGCM, mAllowCommentsGCM, mAllowFollowersGCM, mAllowMessagesGCM, mAllowCommentReplyGCM;

    private ProgressDialog pDialog;

    int mAllowLikes, mAllowComments, mAllowFollowers, mAllowMessages, mAllowCommentReply;
